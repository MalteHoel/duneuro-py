...
meg_transfer_matrix_raw, computation_information = meeg_driver.computeMEGTransferMatrix(driver_cfg)
meg_transfer_matrix = np.array(meg_transfer_matrix_raw)
...
print('Numerically computing secondary magnetic fields')
numerical_fields, computation_information = meeg_driver.applyMEGTransfer(meg_transfer_matrix, dipoles_duneuro, driver_cfg)
numerical_solution = numerical_fields[0]
print('Magnetic fields computed')
